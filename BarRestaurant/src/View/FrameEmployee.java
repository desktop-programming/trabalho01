...
public class FrameEmployee extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jScrollPane12.setViewportView(txtLogin);

        jScrollPane13.setViewportView(txtPassword);

        jScrollPane14.setViewportView(txtID);
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(jScrollPane14, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 46, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(verifyText()){
            controller.insert(new Employee(Integer.parseInt(getTextId()),getTextName(), getTextStreet(), getTextNumber(), getTextNeighborhood(), getTextCity(), getTextUF(),  getTextPhone(), getTextUsername(), getTextPassword()));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if(verifyText()){ 
            controller.update(new Employee(Integer.parseInt(getTextId()),getTextName(), getTextStreet(), getTextNumber(), getTextNeighborhood(), getTextCity(), getTextUF(),  getTextPhone(), getTextUsername(), getTextPassword()));
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        controller.delete(Integer.parseInt(getTextId()));        
        controller.reset();
        cleanTable();
        fillTable();
    ...
    public void fillTable(){
        ...
        for(int i =0 ; i<employees.size();i++){
            ...
            tableEmployee.setValueAt(id, i, 0);
            tableEmployee.setValueAt(name, i, 1);
            tableEmployee.setValueAt(phone, i, 2);
            tableEmployee.setValueAt(address, i, 3);
        }
        getLastEmployeeID();
    }  
    public void getLastEmployeeID(){
        int lastItemID = 0;
        for(int i=0; tableEmployee.getValueAt(i, 0)!=null; i++ )
            lastItemID = (int)tableEmployee.getValueAt(i, 0);
        txtID.setText(Integer.toString(lastItemID+1));
    }
    
    public void cleanTable(){
        for(int i=0; tableEmployee.getValueAt(i, 0)!=null;i++){
                tableEmployee.setValueAt(null, i, 0);
                tableEmployee.setValueAt(null, i, 1);
                tableEmployee.setValueAt(null, i, 2);
                tableEmployee.setValueAt(null, i, 3);
        }
    }
}