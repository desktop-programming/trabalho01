...
public class FrameMainMenu extends javax.swing.JFrame {
    ...
    public void callEmployee(){
        FrameEmployee frame = null;
        try {
            frame = new FrameEmployee();
    ...
    FrameStorage frame = null;
        try {
            frame = new FrameStorage();
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(FrameMainMenu.class.getName()).log(Level.SEVERE, null, ex);
        }
        frame.setVisible(true);
    ...
    private void initComponents() {
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(180, 105));
        ...
        jLabel2.setText("Gerenciar Funcionario");
        ...
        jPanel5.setBackground(new java.awt.Color(58, 134, 247));

        jLabel9.setFont(new java.awt.Font("Microsoft Sans Serif", 1, 24)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setText("Logo do Estabelecimento");
        ...
        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/icons8-account-filled-50.png"))); // NOI18N
        ...
        jMenuItem2.setText("Gerenciar Menu");
        ...
        jMenuItem3.setText("Gerenciar Mesa");
